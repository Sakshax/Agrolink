...
import { User, Lock, ArrowRight, Wheat, ShoppingBag, Loader2 } from 'lucide-react';
...
const MandiAuth = () => {
  ...
  return (
    <div className="min-h-screen bg-cream font-sans flex flex-col items-center justify-center p-6 pb-32">
      {/* App Logo/Branding */}
      <motion.div 
      ...
      >
        ...
        <h1 className="text-3xl font-black text-charcoal tracking-tight">AgroLink Mandi</h1>
        <p className="text-charcoal/40 font-bold uppercase text-[10px] tracking-[0.2em] mt-2">Digital Marketplace</p>
      </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                   <div 
                    ...
                    className={`p-4 rounded-3xl border-2 cursor-pointer transition-all flex flex-col items-center gap-2 ${role === 'Farmer' ? 'border-primary bg-primary/5' : 'border-light-gray hover:border-primary/30'}`}
                   >
                      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${role === 'Farmer' ? 'bg-primary text-white' : 'bg-light-gray text-charcoal/40'}`}>
                   ...
                   <div 
                    ...
                    className={`p-4 rounded-3xl border-2 cursor-pointer transition-all flex flex-col items-center gap-2 ${role === 'Buyer' ? 'border-primary bg-primary/5' : 'border-light-gray hover:border-primary/30'}`}
                   >
                      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${role === 'Buyer' ? 'bg-primary text-white' : 'bg-light-gray text-charcoal/40'}`}>
